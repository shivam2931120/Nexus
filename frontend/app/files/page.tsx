...
export default function FilesPage() {
  ...
  return <AppShell><div className="page nexus-files-page">
    ...
    <div className="nexus-file-metrics"><div><strong>{files.length}</strong><span>FILES IN WORKSPACE</span></div><div><strong>{formatSize(totalBytes)}</strong><span>STORAGE USED</span></div><div><strong>{files.filter(file => typeOf(file) === 'documents').length}</strong><span>DOCUMENT OBJECTS</span></div></div>
