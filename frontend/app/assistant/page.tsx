...
export default function AssistantPage() {
  ...
  return <AppShell><div className="page"><div className="page-heading"><div><div className="eyebrow">WORKSPACE INTELLIGENCE</div><h1>NexusAI</h1><p className="muted">A private NexusAI assistant grounded in your organization’s current workspace context.</p></div></div><div className="grid dashboard-grid"><AiAssistant context={context} /><section className="card"><div className="eyebrow">SAFE BY DEFAULT</div><h2>What it can help with</h2><p className="muted">Summarize documents, identify overdue work, draft meeting follow-ups, and answer questions about workspace activity.</p><p className="muted">The API key stays on the backend. If it is not configured, NexusAI reports that state instead of pretending a response was generated.</p></section></div></div></AppShell>
}
